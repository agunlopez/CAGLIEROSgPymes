...
import Excepciones.ExcepcionNuevoContrato;
import Excepciones.ExcepcionPreciosCuotas;
...
public class NuevoContrato extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        diaPago.setText("10");
        diaPago.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                diaPagoActionPerformed(evt);
            }
        });
        ...
        jLabel32.setText("Numero Seguimiento:");

        numSeguimiento.setText("0");
        numSeguimiento.setName(""); // NOI18N
        numSeguimiento.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                numSeguimientoKeyTyped(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(numSeguimiento, javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(Sellado, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 67, Short.MAX_VALUE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
...
DefaultTableModel model=(DefaultTableModel)tablaCuota.getModel();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        contrato.setNumSegimiento(imp2.getText());
        contrato.setNumeroSeguimietno(Integer.parseInt(numSeguimiento.getText()));
        ...
        //Validamos que esten las fechas de comienzo y vencimiento, dia de pago, y que no se repitan los clientes
        ExcepcionNuevoContrato.rango(fechaComienzo.getDate(),fechaVencimiento.getDate() ,diaPago.getText() ,contrato );
        ...
        //Validamos que se hallan colocado los precios - validamos las cuotas de la garantia
        ExcepcionGarantia.rango(cantidadCuotas, Integer.parseInt(cuotasGarantia.getText()),Integer.parseInt(garantia.getText()),filas);
        
        int fil=tablaCuota.getRowCount()-1;
        int tc=Integer.parseInt((String) tablaCuota.getValueAt(fil, 1));
        
        //Validamos que que los precios de las cuotas esten completos
        ExcepcionPreciosCuotas.rango(cantidadCuotas, tc);
        AltaContrato(contrato);
        } catch (ExcepcionClientesContrato ex) {
            JOptionPane.showMessageDialog(new JDialog(),ex.getMessage());
        } catch (ExcepcionNuevoContrato ex) {
            JOptionPane.showMessageDialog(new JDialog(),ex.getMessage());
        } catch (ExcepcionGarantia ex) {
            JOptionPane.showMessageDialog(new JDialog(),ex.getMessage());
        } catch (ExcepcionPreciosCuotas ex) {
            JOptionPane.showMessageDialog(new JDialog(),ex.getMessage());
        } catch (ParseException ex) {
...
char validar=evt.getKeyChar();
    ...
    private void diaPagoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_diaPagoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_diaPagoActionPerformed
    ...
    private void numSeguimientoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_numSeguimientoKeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_numSeguimientoKeyTyped
    ...
    private javax.swing.JTextField numSeguimiento;
