...
public class AltaInmueble extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ExcepcionAltaInmueble.validarDatos(calle.getText(), numero.getText(),comboProvincia.getSelectedItem().toString(), comboCiudades.getSelectedItem().toString(), propietario.getText());        
        try {
            String fechaInscrip;
            ...
            inm.setLocalidad(comboCiudades.getSelectedItem().toString());
            ...
            inm.setProvincia(comboProvincia.getSelectedItem().toString());
