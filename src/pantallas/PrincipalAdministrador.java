...
public class PrincipalAdministrador extends javax.swing.JFrame  {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Hoy","Semana Actual", "Mes Actual", "Año Actual", "Desde el origen de los tiempos" }));
        ...
        jPanel20.setPreferredSize(new java.awt.Dimension(150, 60));
        ...
        jPanel21.setPreferredSize(new java.awt.Dimension(150, 60));

        jLabel21.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel21.setForeground(new java.awt.Color(255, 255, 255));
        jLabel21.setText("Honorarios");

        txtHonorarios.setEditable(false);
        txtHonorarios.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        jMenuItem19.setText("Lista Inmuebles Disponibles");
        jMenuItem19.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItem19ActionPerformed(evt);
            }
        });
        menuInmuebles.add(jMenuItem19);
 ...
 if(evt.getClickCount()==2){
   ...
   tablaCaja.getColumnModel().getColumn(2).setMaxWidth(50);
   actualizarSaldos();        
        }else if(jComboBox1.getSelectedItem().equals("Semana Actual")){
            periodo=(diaActual-7)+"%"+"/"+(mesActual+1)+"/"+añoActual+"%";
            ArrayList listaCaja=GestorMovimientos.consultaTablaPorEstado(periodo);                                                                      
            ModeloTablaCaja modeloCaja=new ModeloTablaCaja(listaCaja){
                @Override
                public Class getColumnClass(int columna) {
...
AltaCliente altaPropietario=new AltaCliente();
    ...
    private void jMenuItem13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem13ActionPerformed
        ...
        BusquedaIC.setVisible(true);
        // TODO add your handling code here:
    }//GEN-LAST:event_jMenuItem13ActionPerformed

    private void jMenuItem17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem17ActionPerformed
    SeleccionarTipoImpuesto TipoImp=new SeleccionarTipoImpuesto();
        TipoImp.setVisible(true);
        TipoImp.setLocationRelativeTo(null);
        // TODO add your handling code here:
    }//GEN-LAST:event_jMenuItem17ActionPerformed

    private void jMenuItem18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem18ActionPerformed
        AgregarImpuestoCodBarra CodBarra=new AgregarImpuestoCodBarra();
        CodBarra.setVisible(true);
        CodBarra.setLocationRelativeTo(null); 
        // TODO add your handling code here:
    ...
    public static javax.swing.JMenu menuAdminImpuestos1;
     ...
     public static void actualizarSaldos(){
        ...
        for(int i=0; i<tablaCaja.getRowCount();i++){
            ...
            if(tablaCaja.getValueAt(i,7).equals("Ingreso")){
                ...
                String hon=tablaCaja.getValueAt(i,14).toString();
                
                totalPagado= totalPagado+Double.parseDouble(pagado);
                honorarios= honorarios+Double.parseDouble(hon);
